...
public interface Definition<C> extends Locatable, Comparable<Definition<?>> {
	...
	/**
	 * Get the constraints that are explicitly set on the definition (i.e. inherited
	 * and default constraints are not included). This method is intended for use
	 * when persisting the schema model. To obtain information on the constraints of
	 * a definition, use {@link #getConstraint(Class)} instead.
	 *
