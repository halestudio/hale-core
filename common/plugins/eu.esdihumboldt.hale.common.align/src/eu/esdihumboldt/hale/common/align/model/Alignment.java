...
public interface Alignment {
	 ...
	 *
	 * @param entityDefinition the entity definition
	 * @param includeInherited if set, it will also include cells that are mapped to
	 *            the given entity definition on super types
	 * @return the associated cells or an empty collection
	 */
	public Collection<? extends Cell> getCells(EntityDefinition entityDefinition,
	...
	/**
	 * Get the cells associated with the given type. These may be cells associated
	 * to the type or its properties.
	 *
	...
	/**
	 * Get the cells representing a mapping between properties that are associated
	 * with the given cell, not including disabled cells.<br>
	 * The type cell needs to have at least a source or a target set for this method
	 * to return anything.
	 *
...
//	public Collection<? extends Cell> getPropertyCells(Cell typeCell, boolean includeDisabled);
	 ...
	 * returned. Otherwise matching means, that the type cell's sources and target
	 * have to be the same or super types of the query cell's.
	 *
	...
	/**
	 * Returns the cell referenced by the given id string or <code>null</code> if it
	 * cannot be found.
	 *
