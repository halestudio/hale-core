...
public class XMLAlignmentUpdater {
	...
	/**
	 * Reads the given alignment (resource) and searches for included base alignment
	 * in the file. If these files are local, the function tries to copy the
	 * resources into a new directory next to the given alignment and adapts the
